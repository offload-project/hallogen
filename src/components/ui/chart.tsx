...
import { ToggleButtonGroup, type ToggleButtonGroupProps } from "react-aria-components/ToggleButtonGroup";
import type {
              ...
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  ...
                  <div
                    ...
                    {item.value && (
                      <span className="font-medium font-mono text-fg tabular-nums">{item.value.toString()}</span>
                    )}
                  </div>
                </>
              )}
