...
export function Leaderboard({ className, ...props }: ComponentProps<"div">) {
  return <div className={twMerge("flex flex-col gap-y-(--leaderboard-gutter,--spacing(4))", className)} {...props} />;
}

export function LeaderboardHeader({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
...
export function LeaderboardTitle({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
...
export function LeaderboardAction({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
...
export function LeaderboardContent({ className, ...props }: ComponentProps<"ul">) {
  return (
    <ul
...
export function LeaderboardStart({ className, ...props }: LabelProps) {
  return <Label data-slot="leaderboard-start" className={twMerge("flex items-center gap-x-2", className)} {...props} />;
}

export function LeaderboardEnd({ className, ...props }: ComponentProps<"div">) {
  return <div data-slot="leaderboard-start" className={twMerge("tabular-nums", className)} {...props} />;
}
