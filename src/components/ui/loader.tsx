...
const Ring = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
  <svg
...
const Spin = ({ className, ...props }: SVGProps<SVGSVGElement>) => (
  <svg className={twMerge("size-4", className)} viewBox="0 0 2400 2400" {...props} aria-hidden="true">
...
export interface LoaderProps extends Omit<ComponentPropsWithoutRef<"svg">, "display" | "opacity" | "variant"> {
