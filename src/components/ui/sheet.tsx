import { type DialogProps, DialogTrigger as DialogTriggerPrimitive } from "react-aria-components/Dialog";
        ...
        <Dialog className="sm:[--gutter:--spacing(6)]" aria-label={props["aria-label"]} role={role}>
          {(values) => (
            <>
              ...
              {closeButton && <DialogCloseIcon className="end-2.5 top-2.5" isDismissable={isDismissable} />}
            </>
          )}
        </Dialog>
      </Modal>
