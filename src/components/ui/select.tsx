...
import { DropdownDescription, DropdownItem, DropdownLabel, DropdownSection, DropdownSeparator } from "./dropdown";
import { PopoverContent } from "./popover";

interface SelectProps<T, M extends "single" | "multiple" = "single"> extends SelectPrimitiveProps<T, M> {
  items?: Iterable<T, M>;
}

const Select = <T, M extends "single" | "multiple" = "single">({ className, ...props }: SelectProps<T, M>) => {
  return (
    <SelectPrimitive
      data-slot="control"
