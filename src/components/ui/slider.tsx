...
export function SliderOutput({ className, ...props }: ComponentProps<typeof PrimitiveSliderOutput>) {
  return <PrimitiveSliderOutput className={cx("font-medium text-base/6 sm:text-sm/6", className)} {...props} />;
}
...
export function SliderTrack({ className, children, ...props }: ComponentProps<typeof PrimitiveSliderTrack>) {
  return (
